...
PACKAGE BODY p_pile_gen is
    ...
    procedure afficher(F_p:in out T_Pile_Entier) is 
        ...
        if courant /= null then
            loop
            new_line;
            put(Integer'value(courant.all.element));
    ...
    function depiler(F_p:in out T_Pile_Entier) return integer is 
        ...
        exception
            when PILE_VIDE => put("La pile est vide");return val;
            when others => put("il y'a une autre erreur");return val;  
